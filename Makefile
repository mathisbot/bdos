# Retrieve kernel source files and object files
kernel_source_files := $(shell find src/impl/kernel -name *.c)
kernel_object_files := $(patsubst src/impl/kernel/%.c, build/kernel/%.o, $(kernel_source_files))

# Retrieve x86_64 C and ASM source files and object files
...
# Link
.PHONY: build-bdos
build-bdos: $(kernel_object_files) $(x86_64_object_files)
	mkdir -p dist/x86_64 && \
